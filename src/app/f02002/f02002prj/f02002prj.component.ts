...
@Component({
  selector: 'app-f02002prj',
  templateUrl: './f02002prj.component.html',
  styleUrls: ['./f02002prj.component.css', '../../../assets/css/f02.css']
})
export class F02002prjComponent implements OnInit {

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<F02002prjComponent>,
